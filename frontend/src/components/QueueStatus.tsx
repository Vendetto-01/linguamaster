    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
      ...
      {queueStats && (
        <div style={{
          ...
          <h3 style={{ marginTop: 0 }}>🤖 Background Processor</h3>
          ...
          <div style={{ 
            ...
            <div>
              <StatusIndicator 
                ...
                label={queueStats.processorStats.isProcessing ? 'Çalışıyor' : 'Durdu'}
              />
      ...
      {batchStatus && (
        <div style={{
          ...
          <StatusIndicator 
            ...
            label={batchStatus.status === 'processing' ? 'İşleniyor' : 'Tamamlandı'}
            activeColor="#007bff"
